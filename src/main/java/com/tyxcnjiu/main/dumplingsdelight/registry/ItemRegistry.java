...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> ChineseCabbageSeeds = ITEMS.register("chinese_cabbage_seeds",
            ()-> new BlockItem(BlockRegistry.ChineseCabbages.get(), new Item.Properties().tab(DumplingsDelight.DUMPLINGS_DELIGHT_TAB)));
    ...
    public static final RegistryObject<Item> EggplantSeeds = ITEMS.register("eggplant_seeds",
            ()-> new BlockItem(BlockRegistry.Eggplant.get(), new Item.Properties().tab(DumplingsDelight.DUMPLINGS_DELIGHT_TAB)));
    ...
    public static final RegistryObject<Item> GarlicChiveSeeds = ITEMS.register("garlic_chive_seeds",
            ()-> new BlockItem(BlockRegistry.GarlicChive.get(), new Item.Properties().tab(DumplingsDelight.DUMPLINGS_DELIGHT_TAB)));
    ...
    public static final RegistryObject<Item> FennelSeeds = ITEMS.register("fennel_seeds",
            ()-> new BlockItem(BlockRegistry.Fennel.get(), new Item.Properties().tab(DumplingsDelight.DUMPLINGS_DELIGHT_TAB)));
    //Dumplings
